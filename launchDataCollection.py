...
# It searches for folders that contain an apk file inside the workspacePath.
...
class DataCollection:
    ...
    def __init__(self, workspacePath, resultName, emulator, playerPath, VMName, apk_regex, run, event, rndSeed,
                 throttle):
        ...
        self.logger.log("INFO", "CREATED NEW EPERIMENT:  \n\
						...
						\t Number of Event per Run: {} \n\\".format(workspacePath, resultName, emulator, playerPath,
                                                                    VMName, apk_regex, run, event))
