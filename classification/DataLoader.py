...
class DataLoader:
    ...
    # This method loads the data from the pickle file created by feature.txt extractor
    # It returns a dictionary object with multiple keys:
    # - data: the matrix of feature.txt vectors
    ...
    # It returns the same object of load data extended to all data in the dataList
