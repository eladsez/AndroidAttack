...
.method public static a(Landroid/app/Activity;Lcom/google/ads/internal/d;)Landroid/view/ViewGroup;
    ...
    .line 44
    new-instance v1, Landroid/gesture/GestureOverlayView;

    invoke-direct {v1, p0}, Landroid/gesture/GestureOverlayView;-><init>(Landroid/content/Context;)V

    .line 46
    const/4 v2, 0x0

    invoke-virtual {v1, v2}, Landroid/gesture/GestureOverlayView;->setGestureStrokeType(I)V

    .line 47
    const/4 v2, 0x0

    invoke-virtual {v1, v2}, Landroid/gesture/GestureOverlayView;->setEventsInterceptionEnabled(Z)V

    .line 48
    const/4 v2, 0x0

    invoke-virtual {v1, v2}, Landroid/gesture/GestureOverlayView;->setGestureVisible(Z)V

    .line 49
    new-instance v2, Lcom/google/ads/internal/k$a;

    invoke-direct {v2, p0, p1, v0}, Lcom/google/ads/internal/k$a;-><init>(Landroid/app/Activity;Lcom/google/ads/internal/d;Landroid/gesture/GestureStore;)V

    invoke-virtual {v1, v2}, Landroid/gesture/GestureOverlayView;->addOnGesturePerformedListener(Landroid/gesture/GestureOverlayView$OnGesturePerformedListener;)V
    :try_end_0
