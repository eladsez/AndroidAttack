...
# static fields
.field private static synthetic $SWITCH_TABLE$com$parse$entity$mime$HttpMultipartMode:[I
...
# direct methods
.method static synthetic $SWITCH_TABLE$com$parse$entity$mime$HttpMultipartMode()[I
    .locals 3

    .prologue
    .line 51
    sget-object v0, Lcom/parse/entity/mime/HttpMultipart;->$SWITCH_TABLE$com$parse$entity$mime$HttpMultipartMode:[I
    ...
    :goto_2
    sput-object v0, Lcom/parse/entity/mime/HttpMultipart;->$SWITCH_TABLE$com$parse$entity$mime$HttpMultipartMode:[I
...
.method private doWriteTo(Lcom/parse/entity/mime/HttpMultipartMode;Ljava/io/OutputStream;Z)V
    ...
    .prologue
    .line 179
    iget-object v7, p0, Lcom/parse/entity/mime/HttpMultipart;->charset:Ljava/nio/charset/Charset;

    invoke-virtual {p0}, Lcom/parse/entity/mime/HttpMultipart;->getBoundary()Ljava/lang/String;

    move-result-object v8

    invoke-static {v7, v8}, Lcom/parse/entity/mime/HttpMultipart;->encode(Ljava/nio/charset/Charset;Ljava/lang/String;)Lorg/apache/http/util/ByteArrayBuffer;

    move-result-object v0

    .line 180
    .local v0, "boundary":Lorg/apache/http/util/ByteArrayBuffer;
    iget-object v7, p0, Lcom/parse/entity/mime/HttpMultipart;->parts:Ljava/util/List;
    ...
    .line 212
    sget-object v7, Lcom/parse/entity/mime/HttpMultipart;->TWO_DASHES:Lorg/apache/http/util/ByteArrayBuffer;

    invoke-static {v7, p2}, Lcom/parse/entity/mime/HttpMultipart;->writeBytes(Lorg/apache/http/util/ByteArrayBuffer;Ljava/io/OutputStream;)V
    ...
    .line 215
    sget-object v7, Lcom/parse/entity/mime/HttpMultipart;->CR_LF:Lorg/apache/http/util/ByteArrayBuffer;
    ...
    check-cast v6, Lcom/parse/entity/mime/FormBodyPart;

    .line 181
    .local v6, "part":Lcom/parse/entity/mime/FormBodyPart;
    sget-object v8, Lcom/parse/entity/mime/HttpMultipart;->TWO_DASHES:Lorg/apache/http/util/ByteArrayBuffer;

    invoke-static {v8, p2}, Lcom/parse/entity/mime/HttpMultipart;->writeBytes(Lorg/apache/http/util/ByteArrayBuffer;Ljava/io/OutputStream;)V

    .line 182
    invoke-static {v0, p2}, Lcom/parse/entity/mime/HttpMultipart;->writeBytes(Lorg/apache/http/util/ByteArrayBuffer;Ljava/io/OutputStream;)V

    .line 183
    sget-object v8, Lcom/parse/entity/mime/HttpMultipart;->CR_LF:Lorg/apache/http/util/ByteArrayBuffer;

    invoke-static {v8, p2}, Lcom/parse/entity/mime/HttpMultipart;->writeBytes(Lorg/apache/http/util/ByteArrayBuffer;Ljava/io/OutputStream;)V

    .line 185
    invoke-virtual {v6}, Lcom/parse/entity/mime/FormBodyPart;->getHeader()Lcom/parse/entity/mime/Header;

    move-result-object v5

    .line 187
    .local v5, "header":Lcom/parse/entity/mime/Header;
    invoke-static {}, Lcom/parse/entity/mime/HttpMultipart;->$SWITCH_TABLE$com$parse$entity$mime$HttpMultipartMode()[I
    ...
    .line 208
    invoke-virtual {v6}, Lcom/parse/entity/mime/FormBodyPart;->getBody()Lcom/parse/entity/mime/content/ContentBody;

    move-result-object v8

    invoke-interface {v8, p2}, Lcom/parse/entity/mime/content/ContentBody;->writeTo(Ljava/io/OutputStream;)V
    ...
    invoke-virtual {v8, v9}, Lcom/parse/entity/mime/Header;->getField(Ljava/lang/String;)Lcom/parse/entity/mime/MinimalField;

    move-result-object v1

    .line 197
    .local v1, "cd":Lcom/parse/entity/mime/MinimalField;
    iget-object v8, p0, Lcom/parse/entity/mime/HttpMultipart;->charset:Ljava/nio/charset/Charset;

    invoke-static {v1, v8, p2}, Lcom/parse/entity/mime/HttpMultipart;->writeField(Lcom/parse/entity/mime/MinimalField;Ljava/nio/charset/Charset;Ljava/io/OutputStream;)V
    ...
    invoke-interface {v8}, Lcom/parse/entity/mime/content/ContentBody;->getFilename()Ljava/lang/String;
    ...
    invoke-static {v2, v8, p2}, Lcom/parse/entity/mime/HttpMultipart;->writeField(Lcom/parse/entity/mime/MinimalField;Ljava/nio/charset/Charset;Ljava/io/OutputStream;)V
...
.method public getTotalLength()J
    ...
    iget-object v11, p0, Lcom/parse/entity/mime/HttpMultipart;->parts:Ljava/util/List;
    ...
    :try_start_0
    iget-object v11, p0, Lcom/parse/entity/mime/HttpMultipart;->mode:Lcom/parse/entity/mime/HttpMultipartMode;

    const/4 v12, 0x0

    invoke-direct {p0, v11, v7, v12}, Lcom/parse/entity/mime/HttpMultipart;->doWriteTo(Lcom/parse/entity/mime/HttpMultipartMode;Ljava/io/OutputStream;Z)V
