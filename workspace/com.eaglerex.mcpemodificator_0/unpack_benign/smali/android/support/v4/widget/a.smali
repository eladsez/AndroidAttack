...
.method public constructor <init>(Landroid/content/Context;Landroid/database/Cursor;Z)V
    ...
    :goto_0
    invoke-virtual {p0, p1, p2, v0}, Landroid/support/v4/widget/a;->a(Landroid/content/Context;Landroid/database/Cursor;I)V
...
.method a(Landroid/content/Context;Landroid/database/Cursor;I)V
    ...
    iput-object v1, p0, Landroid/support/v4/widget/a;->f:Landroid/support/v4/widget/c;
    ...
    iput-object v1, p0, Landroid/support/v4/widget/a;->g:Landroid/database/DataSetObserver;

    :goto_3
    if-eqz v0, :cond_1

    iget-object v0, p0, Landroid/support/v4/widget/a;->f:Landroid/support/v4/widget/c;
    ...
    :cond_5
    iput-object v3, p0, Landroid/support/v4/widget/a;->f:Landroid/support/v4/widget/c;
...
.method public b(Landroid/database/Cursor;)Landroid/database/Cursor;
    ...
    iget-object v1, p0, Landroid/support/v4/widget/a;->f:Landroid/support/v4/widget/c;
...
.method public getFilter()Landroid/widget/Filter;
    ...
    iget-object v0, p0, Landroid/support/v4/widget/a;->h:Landroid/support/v4/widget/e;
    ...
    iput-object v0, p0, Landroid/support/v4/widget/a;->h:Landroid/support/v4/widget/e;
