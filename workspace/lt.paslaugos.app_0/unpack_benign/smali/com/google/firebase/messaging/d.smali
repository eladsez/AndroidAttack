...
# static fields
.field private static a:Lcom/google/firebase/messaging/d;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/google/firebase/messaging/d;->f:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method private final a(Ljava/lang/CharSequence;Ljava/lang/String;ILjava/lang/Integer;Landroid/net/Uri;Landroid/app/PendingIntent;Landroid/app/PendingIntent;Ljava/lang/String;)Landroid/app/Notification;
    ...
    iget-object p1, p0, Lcom/google/firebase/messaging/d;->d:Ljava/lang/reflect/Method;

    if-nez p1, :cond_6

    const-string p1, "setChannelId"

    invoke-static {p1}, Lcom/google/firebase/messaging/d;->a(Ljava/lang/String;)Ljava/lang/reflect/Method;

    move-result-object p1

    iput-object p1, p0, Lcom/google/firebase/messaging/d;->d:Ljava/lang/reflect/Method;
...
.method static declared-synchronized a(Landroid/content/Context;)Lcom/google/firebase/messaging/d;
    ...
    :try_start_0
    sget-object v1, Lcom/google/firebase/messaging/d;->a:Lcom/google/firebase/messaging/d;

    if-nez v1, :cond_0

    new-instance v1, Lcom/google/firebase/messaging/d;

    invoke-direct {v1, p0}, Lcom/google/firebase/messaging/d;-><init>(Landroid/content/Context;)V

    sput-object v1, Lcom/google/firebase/messaging/d;->a:Lcom/google/firebase/messaging/d;

    :cond_0
    sget-object p0, Lcom/google/firebase/messaging/d;->a:Lcom/google/firebase/messaging/d;
    :try_end_0
...
.method private final c(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_0
    iget-object v2, p0, Lcom/google/firebase/messaging/d;->e:Ljava/lang/reflect/Method;
    ...
    iput-object v2, p0, Lcom/google/firebase/messaging/d;->e:Ljava/lang/reflect/Method;
    ...
    :goto_1
    iget-object p1, p0, Lcom/google/firebase/messaging/d;->e:Ljava/lang/reflect/Method;
...
.method private final e(Landroid/os/Bundle;)Landroid/app/PendingIntent;
    ...
    :cond_6
    iget-object p1, p0, Lcom/google/firebase/messaging/d;->b:Landroid/content/Context;

    iget-object v0, p0, Lcom/google/firebase/messaging/d;->f:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method final c(Landroid/os/Bundle;)Z
    ...
    invoke-direct {p0, v6}, Lcom/google/firebase/messaging/d;->a(I)Z
    ...
    invoke-direct {p0, v3}, Lcom/google/firebase/messaging/d;->a(I)Z
    ...
    invoke-direct {p0, v0}, Lcom/google/firebase/messaging/d;->b(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    iget-object v10, p0, Lcom/google/firebase/messaging/d;->b:Landroid/content/Context;
    ...
    invoke-static {v8, p1}, Lcom/google/firebase/messaging/d;->a(Landroid/content/Intent;Landroid/os/Bundle;)V
    ...
    iget-object v9, p0, Lcom/google/firebase/messaging/d;->f:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-static {v3, v9, v8, v10}, Lcom/google/firebase/iid/ad;->a(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    iget-object v9, p0, Lcom/google/firebase/messaging/d;->b:Landroid/content/Context;

    iget-object v11, p0, Lcom/google/firebase/messaging/d;->f:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v11}, Ljava/util/concurrent/atomic/AtomicInteger;->incrementAndGet()I

    move-result v11

    invoke-static {v9, v11, v8, v10}, Lcom/google/firebase/iid/ad;->a(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-static {p1, v3}, Lcom/google/firebase/messaging/d;->a(Landroid/os/Bundle;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    invoke-direct {p0, v3}, Lcom/google/firebase/messaging/d;->c(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct/range {v3 .. v11}, Lcom/google/firebase/messaging/d;->a(Ljava/lang/CharSequence;Ljava/lang/String;ILjava/lang/Integer;Landroid/net/Uri;Landroid/app/PendingIntent;Landroid/app/PendingIntent;Ljava/lang/String;)Landroid/app/Notification;
    ...
    :cond_10
    new-instance v3, Landroid/support/v4/app/y$c;

    iget-object v8, p0, Lcom/google/firebase/messaging/d;->b:Landroid/content/Context;

    invoke-direct {v3, v8}, Landroid/support/v4/app/y$c;-><init>(Landroid/content/Context;)V

    invoke-virtual {v3, v1}, Landroid/support/v4/app/y$c;->a(Z)Landroid/support/v4/app/y$c;

    move-result-object v3

    invoke-virtual {v3, v6}, Landroid/support/v4/app/y$c;->a(I)Landroid/support/v4/app/y$c;
    ...
    invoke-virtual {v3, v4}, Landroid/support/v4/app/y$c;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/y$c;
    ...
    invoke-virtual {v3, v5}, Landroid/support/v4/app/y$c;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/y$c;

    new-instance v4, Landroid/support/v4/app/y$b;

    invoke-direct {v4}, Landroid/support/v4/app/y$b;-><init>()V

    invoke-virtual {v4, v5}, Landroid/support/v4/app/y$b;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/y$b;

    move-result-object v4

    invoke-virtual {v3, v4}, Landroid/support/v4/app/y$c;->a(Landroid/support/v4/app/y$d;)Landroid/support/v4/app/y$c;
    ...
    invoke-virtual {v3, v4}, Landroid/support/v4/app/y$c;->c(I)Landroid/support/v4/app/y$c;

    :cond_13
    if-eqz v0, :cond_14

    invoke-virtual {v3, v0}, Landroid/support/v4/app/y$c;->a(Landroid/net/Uri;)Landroid/support/v4/app/y$c;

    :cond_14
    if-eqz v9, :cond_15

    invoke-virtual {v3, v9}, Landroid/support/v4/app/y$c;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/y$c;

    :cond_15
    if-eqz v10, :cond_16

    invoke-virtual {v3, v10}, Landroid/support/v4/app/y$c;->b(Landroid/app/PendingIntent;)Landroid/support/v4/app/y$c;

    :cond_16
    invoke-virtual {v3}, Landroid/support/v4/app/y$c;->a()Landroid/app/Notification;
