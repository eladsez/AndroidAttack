...
.method public static a(Landroid/content/Context;Lcom/google/android/gms/common/api/internal/r;)Lcom/google/android/gms/common/api/internal/q;
    ...
    invoke-static {p0, v0}, Lcom/google/android/gms/common/y;->zzr(Landroid/content/Context;Ljava/lang/String;)Z
...
.method private final a(Landroid/content/Context;Landroid/app/NotificationManager;)Ljava/lang/String;
    ...
    invoke-static {p1}, Lcom/google/android/gms/common/internal/bb;->a(Landroid/content/Context;)Ljava/lang/String;
...
.method static a(Landroid/app/Activity;Landroid/app/Dialog;Ljava/lang/String;Landroid/content/DialogInterface$OnCancelListener;)V
    ...
    invoke-virtual {p1, p0, p2}, Lcom/google/android/gms/common/f;->a(Landroid/support/v4/app/n;Ljava/lang/String;)V
...
.method private final a(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    invoke-direct {v3, p1}, Landroid/support/v4/app/y$c;-><init>(Landroid/content/Context;)V

    const v5, 0x108008a

    invoke-virtual {v3, v5}, Landroid/support/v4/app/y$c;->a(I)Landroid/support/v4/app/y$c;
    ...
    invoke-virtual {v3, v1}, Landroid/support/v4/app/y$c;->c(Ljava/lang/CharSequence;)Landroid/support/v4/app/y$c;
    ...
    invoke-virtual {v1, v5, v6}, Landroid/support/v4/app/y$c;->a(J)Landroid/support/v4/app/y$c;

    move-result-object v1

    invoke-virtual {v1, v4}, Landroid/support/v4/app/y$c;->a(Z)Landroid/support/v4/app/y$c;

    move-result-object v1

    invoke-virtual {v1, p4}, Landroid/support/v4/app/y$c;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/y$c;

    move-result-object p4

    invoke-virtual {p4, p3}, Landroid/support/v4/app/y$c;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/y$c;

    move-result-object p3

    invoke-virtual {p3, v0}, Landroid/support/v4/app/y$c;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/y$c;

    move-result-object p3

    invoke-virtual {p3, v4}, Landroid/support/v4/app/y$c;->b(Z)Landroid/support/v4/app/y$c;

    move-result-object p3

    new-instance p4, Landroid/support/v4/app/y$b;

    invoke-direct {p4}, Landroid/support/v4/app/y$b;-><init>()V

    invoke-virtual {p4, v0}, Landroid/support/v4/app/y$b;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/y$b;

    move-result-object p4

    invoke-virtual {p3, p4}, Landroid/support/v4/app/y$c;->a(Landroid/support/v4/app/y$d;)Landroid/support/v4/app/y$c;
    ...
    invoke-virtual {p3, p1}, Landroid/support/v4/app/y$c;->a(Ljava/lang/String;)Landroid/support/v4/app/y$c;

    :cond_5
    invoke-virtual {p3}, Landroid/support/v4/app/y$c;->a()Landroid/app/Notification;
    ...
    sget-object p3, Lcom/google/android/gms/common/y;->zzfrv:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public a(Landroid/app/Activity;IILandroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
    ...
    invoke-static {p1, p2, v0}, Lcom/google/android/gms/common/l;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {p1, p2, p3, p4}, Lcom/google/android/gms/common/c;->a(Landroid/content/Context;ILcom/google/android/gms/common/internal/bc;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
...
.method public a(Landroid/content/Context;Lcom/google/android/gms/common/a;)Landroid/app/PendingIntent;
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcom/google/android/gms/common/l;->a(Landroid/content/Context;II)Landroid/app/PendingIntent;
...
.method public a(Landroid/content/Context;I)V
    ...
    invoke-virtual {p0, p1, p2, v1, v0}, Lcom/google/android/gms/common/l;->a(Landroid/content/Context;IILjava/lang/String;)Landroid/app/PendingIntent;
...
.method public final a(Landroid/app/Activity;Lcom/google/android/gms/common/api/internal/v;IILandroid/content/DialogInterface$OnCancelListener;)Z
    .locals 1

    const-string p4, "d"

    invoke-static {p1, p3, p4}, Lcom/google/android/gms/common/l;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;

    move-result-object p4

    const/4 v0, 0x2

    invoke-static {p2, p4, v0}, Lcom/google/android/gms/common/internal/bc;->a(Lcom/google/android/gms/common/api/internal/v;Landroid/content/Intent;I)Lcom/google/android/gms/common/internal/bc;

    move-result-object p2

    invoke-static {p1, p3, p2, p5}, Lcom/google/android/gms/common/c;->a(Landroid/content/Context;ILcom/google/android/gms/common/internal/bc;Landroid/content/DialogInterface$OnCancelListener;)Landroid/app/Dialog;
