...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/a/d;->a:Landroid/util/SparseArray;

    const/4 v0, 0x1

    sput v0, Landroid/support/v4/a/d;->b:I
...
.method public static a(Landroid/content/Intent;)Z
    ...
    :cond_0
    sget-object v0, Landroid/support/v4/a/d;->a:Landroid/util/SparseArray;

    monitor-enter v0

    :try_start_0
    sget-object v1, Landroid/support/v4/a/d;->a:Landroid/util/SparseArray;
...
.method public static a_(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/ComponentName;
    ...
    :try_start_0
    sget v1, Landroid/support/v4/a/d;->b:I

    sget v2, Landroid/support/v4/a/d;->b:I

    const/4 v3, 0x1

    add-int/2addr v2, v3

    sput v2, Landroid/support/v4/a/d;->b:I

    sget v2, Landroid/support/v4/a/d;->b:I

    if-gtz v2, :cond_0

    sput v3, Landroid/support/v4/a/d;->b:I
    ...
    sget-object v2, Landroid/support/v4/a/d;->a:Landroid/util/SparseArray;
