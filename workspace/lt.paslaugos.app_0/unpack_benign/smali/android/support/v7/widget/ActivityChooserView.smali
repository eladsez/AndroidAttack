...
.method a(I)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/ActivityChooserView;->getListPopupWindow()Landroid/support/v7/widget/af;

    move-result-object p1

    invoke-virtual {p1}, Landroid/support/v7/widget/af;->d()Z
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/widget/af;->g(I)V
    ...
    :cond_4
    invoke-virtual {p1}, Landroid/support/v7/widget/af;->e()Landroid/widget/ListView;
...
.method getListPopupWindow()Landroid/support/v7/widget/af;
    .locals 2

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->n:Landroid/support/v7/widget/af;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->n:Landroid/support/v7/widget/af;

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->n:Landroid/support/v7/widget/af;

    iget-object v1, p0, Landroid/support/v7/widget/ActivityChooserView;->a:Landroid/support/v7/widget/ActivityChooserView$a;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/af;->a(Landroid/widget/ListAdapter;)V

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->n:Landroid/support/v7/widget/af;

    invoke-virtual {v0, p0}, Landroid/support/v7/widget/af;->b(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/af;->a(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->n:Landroid/support/v7/widget/af;

    iget-object v1, p0, Landroid/support/v7/widget/ActivityChooserView;->i:Landroid/support/v7/widget/ActivityChooserView$b;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/af;->a(Landroid/widget/PopupWindow$OnDismissListener;)V
