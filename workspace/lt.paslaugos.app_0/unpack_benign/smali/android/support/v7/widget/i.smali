...
.field private static b:Landroid/support/v7/widget/i;

.field private static final c:Landroid/support/v7/widget/i$b;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/i;->a:Landroid/graphics/PorterDuff$Mode;

    new-instance v0, Landroid/support/v7/widget/i$b;

    const/4 v1, 0x6

    invoke-direct {v0, v1}, Landroid/support/v7/widget/i$b;-><init>(I)V

    sput-object v0, Landroid/support/v7/widget/i;->c:Landroid/support/v7/widget/i$b;
    ...
    sput-object v2, Landroid/support/v7/widget/i;->d:[I
    ...
    sput-object v3, Landroid/support/v7/widget/i;->e:[I
    ...
    sput-object v3, Landroid/support/v7/widget/i;->f:[I
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/i;->m:Ljava/lang/Object;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/i;->n:Ljava/util/WeakHashMap;
...
.method private a(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v0}, Landroid/support/v7/widget/as;->a(Landroid/content/Context;I)I

    move-result v0

    invoke-direct {p0, p1, v0}, Landroid/support/v7/widget/i;->f(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public static a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    sget-object v0, Landroid/support/v7/widget/i;->c:Landroid/support/v7/widget/i$b;
    ...
    sget-object v1, Landroid/support/v7/widget/i;->c:Landroid/support/v7/widget/i$b;
...
.method private static a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;[I)Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-static {p0, p1}, Landroid/support/v7/widget/i;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method private a(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p4}, Landroid/support/v7/widget/x;->b(Landroid/graphics/drawable/Drawable;)Z
    ...
    sget-object v3, Landroid/support/v7/widget/i;->a:Landroid/graphics/PorterDuff$Mode;

    invoke-static {p3, v0, v3}, Landroid/support/v7/widget/i;->a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    sget-object v2, Landroid/support/v7/widget/i;->a:Landroid/graphics/PorterDuff$Mode;

    invoke-static {p3, v0, v2}, Landroid/support/v7/widget/i;->a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1, p3}, Landroid/support/v7/widget/as;->a(Landroid/content/Context;I)I

    move-result p1

    sget-object p3, Landroid/support/v7/widget/i;->a:Landroid/graphics/PorterDuff$Mode;

    invoke-static {p2, p1, p3}, Landroid/support/v7/widget/i;->a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1, v0}, Landroid/support/v7/widget/as;->c(Landroid/content/Context;I)I
...
.method private a(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/i;->m:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Landroid/support/v7/widget/i;->n:Ljava/util/WeakHashMap;
...
.method public static a()Landroid/support/v7/widget/i;
    ...
    sget-object v0, Landroid/support/v7/widget/i;->b:Landroid/support/v7/widget/i;
    ...
    sput-object v0, Landroid/support/v7/widget/i;->b:Landroid/support/v7/widget/i;

    sget-object v0, Landroid/support/v7/widget/i;->b:Landroid/support/v7/widget/i;

    invoke-static {v0}, Landroid/support/v7/widget/i;->a(Landroid/support/v7/widget/i;)V
...
.method private a(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/i;->j:Ljava/util/WeakHashMap;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/i;->j:Ljava/util/WeakHashMap;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/i;->j:Ljava/util/WeakHashMap;
...
.method private static a(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p0}, Landroid/support/v7/widget/x;->b(Landroid/graphics/drawable/Drawable;)Z
    ...
    sget-object p2, Landroid/support/v7/widget/i;->a:Landroid/graphics/PorterDuff$Mode;
...
.method static a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/av;[I)V
    ...
    :cond_0
    iget-boolean v0, p1, Landroid/support/v7/widget/av;->d:Z

    if-nez v0, :cond_2

    iget-boolean v0, p1, Landroid/support/v7/widget/av;->c:Z
    ...
    iget-object v0, p1, Landroid/support/v7/widget/av;->a:Landroid/content/res/ColorStateList;
    ...
    :goto_1
    iget-boolean v1, p1, Landroid/support/v7/widget/av;->c:Z

    if-eqz v1, :cond_4

    iget-object p1, p1, Landroid/support/v7/widget/av;->b:Landroid/graphics/PorterDuff$Mode;

    goto :goto_2

    :cond_4
    sget-object p1, Landroid/support/v7/widget/i;->a:Landroid/graphics/PorterDuff$Mode;

    :goto_2
    invoke-static {v0, p1, p2}, Landroid/support/v7/widget/i;->a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;[I)Landroid/graphics/PorterDuffColorFilter;
...
.method private static a(Landroid/support/v7/widget/i;)V
    .locals 2
    ...
    new-instance v1, Landroid/support/v7/widget/i$d;

    invoke-direct {v1}, Landroid/support/v7/widget/i$d;-><init>()V

    invoke-direct {p0, v0, v1}, Landroid/support/v7/widget/i;->a(Ljava/lang/String;Landroid/support/v7/widget/i$c;)V

    const-string v0, "animated-vector"

    new-instance v1, Landroid/support/v7/widget/i$a;

    invoke-direct {v1}, Landroid/support/v7/widget/i$a;-><init>()V
...
.method private a(Ljava/lang/String;Landroid/support/v7/widget/i$c;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/i;->k:Landroid/support/v4/g/a;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/i;->k:Landroid/support/v4/g/a;
...
.method static a(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    sget-object v0, Landroid/support/v7/widget/i;->a:Landroid/graphics/PorterDuff$Mode;

    sget-object v1, Landroid/support/v7/widget/i;->d:[I

    invoke-static {v1, p1}, Landroid/support/v7/widget/i;->a([II)Z
    ...
    :cond_0
    sget-object v1, Landroid/support/v7/widget/i;->f:[I
    ...
    invoke-static {p2}, Landroid/support/v7/widget/x;->b(Landroid/graphics/drawable/Drawable;)Z
    ...
    :cond_5
    invoke-static {p0, v2}, Landroid/support/v7/widget/as;->a(Landroid/content/Context;I)I

    move-result p0

    invoke-static {p0, v0}, Landroid/support/v7/widget/i;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method private a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    iget-object v2, p0, Landroid/support/v7/widget/i;->n:Ljava/util/WeakHashMap;
...
.method private c(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0}, Landroid/support/v7/widget/i;->a(Landroid/util/TypedValue;)J

    move-result-wide v3

    invoke-direct {p0, p1, v3, v4}, Landroid/support/v7/widget/i;->a(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, v6}, Landroid/support/v7/widget/i;->a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, v5}, Landroid/support/v7/widget/i;->a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, v3, v4, v1}, Landroid/support/v7/widget/i;->a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
...
.method private d(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Landroid/support/v7/widget/as;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget-object v6, Landroid/support/v7/widget/as;->a:[I
    ...
    sget-object v5, Landroid/support/v7/widget/as;->e:[I

    aput-object v5, v1, v4

    sget v5, Landroid/support/v7/a/a$a;->colorControlActivated:I

    invoke-static {p1, v5}, Landroid/support/v7/widget/as;->a(Landroid/content/Context;I)I

    move-result p1

    aput p1, v0, v4

    sget-object p1, Landroid/support/v7/widget/as;->h:[I
    ...
    :cond_0
    sget-object v2, Landroid/support/v7/widget/as;->a:[I

    aput-object v2, v1, v5

    sget v2, Landroid/support/v7/a/a$a;->colorSwitchThumbNormal:I

    invoke-static {p1, v2}, Landroid/support/v7/widget/as;->c(Landroid/content/Context;I)I

    move-result v2

    aput v2, v0, v5

    sget-object v2, Landroid/support/v7/widget/as;->e:[I

    aput-object v2, v1, v4

    sget v2, Landroid/support/v7/a/a$a;->colorControlActivated:I

    invoke-static {p1, v2}, Landroid/support/v7/widget/as;->a(Landroid/content/Context;I)I

    move-result v2

    aput v2, v0, v4

    sget-object v2, Landroid/support/v7/widget/as;->h:[I
...
.method private d(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/i;->l:Landroid/support/v4/g/n;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/i;->k:Landroid/support/v4/g/a;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/i;->l:Landroid/support/v4/g/n;
    ...
    iget-object v7, p0, Landroid/support/v7/widget/i;->l:Landroid/support/v4/g/n;

    invoke-virtual {v7, p2, v2}, Landroid/support/v4/g/n;->c(ILjava/lang/Object;)V

    iget-object v7, p0, Landroid/support/v7/widget/i;->k:Landroid/support/v4/g/a;

    invoke-virtual {v7, v2}, Landroid/support/v4/g/a;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v2

    check-cast v2, Landroid/support/v7/widget/i$c;
    ...
    invoke-interface {v2, p1, v1, v6, v7}, Landroid/support/v7/widget/i$c;->a(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, v3, v4, v5}, Landroid/support/v7/widget/i;->a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    iget-object p1, p0, Landroid/support/v7/widget/i;->l:Landroid/support/v4/g/n;
...
.method private e(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, p1, v0}, Landroid/support/v7/widget/i;->a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object p1

    if-eqz p1, :cond_1

    invoke-static {p1}, Landroid/support/v7/widget/i;->a(Landroid/graphics/drawable/Drawable;)Z
    ...
    iput-boolean p1, p0, Landroid/support/v7/widget/i;->p:Z
...
.method private f(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v3}, Landroid/support/v7/widget/as;->c(Landroid/content/Context;I)I

    move-result p1

    sget-object v3, Landroid/support/v7/widget/as;->a:[I
    ...
    sget-object p1, Landroid/support/v7/widget/as;->d:[I
    ...
    sget-object p1, Landroid/support/v7/widget/as;->b:[I
...
.method public a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, p2, v0}, Landroid/support/v7/widget/i;->a(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
...
.method a(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/widget/i;->e(Landroid/content/Context;)V

    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/i;->d(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, p2, p3, v0}, Landroid/support/v7/widget/i;->a(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method a(Landroid/content/Context;Landroid/support/v7/widget/bc;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, p3}, Landroid/support/v7/widget/i;->d(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, p3, p2, v0}, Landroid/support/v7/widget/i;->a(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/i;->e(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/widget/i;->d(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/widget/i;->c(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    :cond_6
    sget-object v1, Landroid/support/v7/widget/i;->e:[I
    ...
    invoke-static {p1, v0}, Landroid/support/v7/widget/as;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :cond_7
    sget-object v1, Landroid/support/v7/widget/i;->h:[I
    ...
    :cond_8
    sget-object v1, Landroid/support/v7/widget/i;->i:[I
