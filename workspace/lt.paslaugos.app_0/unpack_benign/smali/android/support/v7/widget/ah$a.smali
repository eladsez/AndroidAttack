...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    iput v1, p0, Landroid/support/v7/widget/ah$a;->b:I

    goto :goto_0

    :cond_0
    iput v1, p0, Landroid/support/v7/widget/ah$a;->a:I

    iput v0, p0, Landroid/support/v7/widget/ah$a;->b:I
...
.method public bridge synthetic a(IIIII)I
    ...
    invoke-super/range {p0 .. p5}, Landroid/support/v7/widget/y;->a(IIIII)I
...
.method public onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ah$a;->c:Landroid/support/v7/widget/ag;
    ...
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/ah$a;->d:Landroid/view/MenuItem;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/ah$a;->c:Landroid/support/v7/widget/ag;

    invoke-interface {v3, v0, v1}, Landroid/support/v7/widget/ag;->a(Landroid/support/v7/view/menu/g;Landroid/view/MenuItem;)V

    :cond_2
    iput-object v2, p0, Landroid/support/v7/widget/ah$a;->d:Landroid/view/MenuItem;

    if-eqz v2, :cond_3

    iget-object v1, p0, Landroid/support/v7/widget/ah$a;->c:Landroid/support/v7/widget/ag;

    invoke-interface {v1, v0, v2}, Landroid/support/v7/widget/ag;->b(Landroid/support/v7/view/menu/g;Landroid/view/MenuItem;)V
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    iget v2, p0, Landroid/support/v7/widget/ah$a;->a:I
    ...
    invoke-virtual {p0, v0, p1, v2, v3}, Landroid/support/v7/widget/ah$a;->performItemClick(Landroid/view/View;IJ)Z
    ...
    iget v0, p0, Landroid/support/v7/widget/ah$a;->b:I

    if-ne p1, v0, :cond_2

    const/4 p1, -0x1

    invoke-virtual {p0, p1}, Landroid/support/v7/widget/ah$a;->setSelection(I)V
...
.method public setHoverListener(Landroid/support/v7/widget/ag;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/ah$a;->c:Landroid/support/v7/widget/ag;
