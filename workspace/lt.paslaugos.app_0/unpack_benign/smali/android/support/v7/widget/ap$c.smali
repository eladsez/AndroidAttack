...
# direct methods
.method public constructor <init>(Landroid/support/v7/widget/ap;Landroid/content/Context;Landroid/support/v7/app/a$b;Z)V
    .locals 3
    ...
    iput-object p3, p0, Landroid/support/v7/widget/ap$c;->c:Landroid/support/v7/app/a$b;

    iget-object p1, p0, Landroid/support/v7/widget/ap$c;->b:[I

    sget p3, Landroid/support/v7/a/a$a;->actionBarTabStyle:I

    invoke-static {p2, v0, p1, p3, v1}, Landroid/support/v7/widget/ax;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/ax;

    move-result-object p1

    invoke-virtual {p1, v1}, Landroid/support/v7/widget/ax;->f(I)Z

    move-result p2

    if-eqz p2, :cond_0

    invoke-virtual {p1, v1}, Landroid/support/v7/widget/ax;->a(I)Landroid/graphics/drawable/Drawable;
...
.method public a()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ap$c;->c:Landroid/support/v7/app/a$b;
    ...
    invoke-direct {v8, v9}, Landroid/support/v7/widget/n;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v2, v8, v3, v9}, Landroid/support/v7/widget/s;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public a(Landroid/support/v7/app/a$b;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/ap$c;->c:Landroid/support/v7/app/a$b;
