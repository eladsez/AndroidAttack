...
.method public constructor <init>(Landroid/support/v7/widget/ak;)V
    ...
    new-instance p1, Landroid/support/v7/widget/al$a;

    invoke-direct {p1, p0}, Landroid/support/v7/widget/al$a;-><init>(Landroid/support/v7/widget/al;)V

    iput-object p1, p0, Landroid/support/v7/widget/al;->c:Landroid/support/v4/h/b;
...
.method public a(Landroid/view/View;Landroid/support/v4/h/a/b;)V
    ...
    const-class p1, Landroid/support/v7/widget/ak;
    ...
    iget-object p1, p0, Landroid/support/v7/widget/al;->a:Landroid/support/v7/widget/ak;

    invoke-virtual {p1}, Landroid/support/v7/widget/ak;->getLayoutManager()Landroid/support/v7/widget/ak$i;
    ...
    invoke-virtual {p1, p2}, Landroid/support/v7/widget/ak$i;->a(Landroid/support/v4/h/a/b;)V
...
.method public a(Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    invoke-virtual {p1, p2}, Landroid/support/v7/widget/ak$i;->a(Landroid/view/accessibility/AccessibilityEvent;)V
...
.method public a(Landroid/view/View;ILandroid/os/Bundle;)Z
    ...
    invoke-virtual {p1, p2, p3}, Landroid/support/v7/widget/ak$i;->a(ILandroid/os/Bundle;)Z
...
.method b()Z
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ak;->v()Z
...
.method public c()Landroid/support/v4/h/b;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/al;->c:Landroid/support/v4/h/b;
