...
.method private a(Landroid/support/v7/widget/ak;IJ)Landroid/support/v7/widget/ak$x;
    .locals 2

    invoke-static {p1, p2}, Landroid/support/v7/widget/ac;->a(Landroid/support/v7/widget/ak;I)Z
    ...
    :cond_0
    iget-object v0, p1, Landroid/support/v7/widget/ak;->d:Landroid/support/v7/widget/ak$p;

    const/4 v1, 0x0

    :try_start_0
    invoke-virtual {p1}, Landroid/support/v7/widget/ak;->l()V

    invoke-virtual {v0, p2, v1, p3, p4}, Landroid/support/v7/widget/ak$p;->a(IZJ)Landroid/support/v7/widget/ak$x;

    move-result-object p2

    if-eqz p2, :cond_2

    invoke-virtual {p2}, Landroid/support/v7/widget/ak$x;->p()Z

    move-result p3

    if-eqz p3, :cond_1

    invoke-virtual {p2}, Landroid/support/v7/widget/ak$x;->n()Z

    move-result p3

    if-nez p3, :cond_1

    iget-object p3, p2, Landroid/support/v7/widget/ak$x;->a:Landroid/view/View;

    invoke-virtual {v0, p3}, Landroid/support/v7/widget/ak$p;->a(Landroid/view/View;)V

    goto :goto_0

    :cond_1
    invoke-virtual {v0, p2, v1}, Landroid/support/v7/widget/ak$p;->a(Landroid/support/v7/widget/ak$x;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :cond_2
    :goto_0
    invoke-virtual {p1, v1}, Landroid/support/v7/widget/ak;->b(Z)V
...
.method private a()V
    ...
    check-cast v4, Landroid/support/v7/widget/ak;

    invoke-virtual {v4}, Landroid/support/v7/widget/ak;->getWindowVisibility()I

    move-result v5

    if-nez v5, :cond_0

    iget-object v5, v4, Landroid/support/v7/widget/ak;->B:Landroid/support/v7/widget/ac$a;

    invoke-virtual {v5, v4, v1}, Landroid/support/v7/widget/ac$a;->a(Landroid/support/v7/widget/ak;Z)V
    ...
    iput-object v4, v8, Landroid/support/v7/widget/ac$b;->d:Landroid/support/v7/widget/ak;
...
.method private a(Landroid/support/v7/widget/ac$b;J)V
    ...
    :goto_0
    iget-object v2, p1, Landroid/support/v7/widget/ac$b;->d:Landroid/support/v7/widget/ak;

    iget p1, p1, Landroid/support/v7/widget/ac$b;->e:I

    invoke-direct {p0, v2, p1, v0, v1}, Landroid/support/v7/widget/ac;->a(Landroid/support/v7/widget/ak;IJ)Landroid/support/v7/widget/ak$x;

    move-result-object p1

    if-eqz p1, :cond_1

    iget-object v0, p1, Landroid/support/v7/widget/ak$x;->b:Ljava/lang/ref/WeakReference;

    if-eqz v0, :cond_1

    invoke-virtual {p1}, Landroid/support/v7/widget/ak$x;->p()Z
    ...
    iget-object p1, p1, Landroid/support/v7/widget/ak$x;->b:Ljava/lang/ref/WeakReference;
    ...
    invoke-direct {p0, p1, p2, p3}, Landroid/support/v7/widget/ac;->a(Landroid/support/v7/widget/ak;J)V

    :cond_1
    return-void
.end method

.method private a(Landroid/support/v7/widget/ak;J)V
    .locals 3
    ...
    :cond_0
    iget-boolean v0, p1, Landroid/support/v7/widget/ak;->w:Z
    ...
    :cond_1
    iget-object v0, p1, Landroid/support/v7/widget/ak;->B:Landroid/support/v7/widget/ac$a;

    const/4 v1, 0x1

    invoke-virtual {v0, p1, v1}, Landroid/support/v7/widget/ac$a;->a(Landroid/support/v7/widget/ak;Z)V
    ...
    iget-object v1, p1, Landroid/support/v7/widget/ak;->C:Landroid/support/v7/widget/ak$u;

    iget-object v2, p1, Landroid/support/v7/widget/ak;->l:Landroid/support/v7/widget/ak$a;

    invoke-virtual {v1, v2}, Landroid/support/v7/widget/ak$u;->a(Landroid/support/v7/widget/ak$a;)V
    ...
    invoke-direct {p0, p1, v2, p2, p3}, Landroid/support/v7/widget/ac;->a(Landroid/support/v7/widget/ak;IJ)Landroid/support/v7/widget/ak$x;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method static a(Landroid/support/v7/widget/ak;I)Z
    .locals 5

    iget-object v0, p0, Landroid/support/v7/widget/ak;->f:Landroid/support/v7/widget/u;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/ak;->f:Landroid/support/v7/widget/u;

    invoke-virtual {v3, v2}, Landroid/support/v7/widget/u;->d(I)Landroid/view/View;

    move-result-object v3

    invoke-static {v3}, Landroid/support/v7/widget/ak;->e(Landroid/view/View;)Landroid/support/v7/widget/ak$x;

    move-result-object v3

    iget v4, v3, Landroid/support/v7/widget/ak$x;->c:I
...
.method private b(J)V
    ...
    iget-object v2, v1, Landroid/support/v7/widget/ac$b;->d:Landroid/support/v7/widget/ak;
...
.method a(Landroid/support/v7/widget/ak;II)V
    .locals 4

    invoke-virtual {p1}, Landroid/support/v7/widget/ak;->isAttachedToWindow()Z
    ...
    invoke-virtual {p1}, Landroid/support/v7/widget/ak;->getNanoTime()J

    move-result-wide v0

    iput-wide v0, p0, Landroid/support/v7/widget/ac;->c:J

    invoke-virtual {p1, p0}, Landroid/support/v7/widget/ak;->post(Ljava/lang/Runnable;)Z

    :cond_0
    iget-object p1, p1, Landroid/support/v7/widget/ak;->B:Landroid/support/v7/widget/ac$a;
...
.method public run()V
    ...
    invoke-static {v2}, Landroid/support/v4/e/d;->a(Ljava/lang/String;)V
    ...
    check-cast v6, Landroid/support/v7/widget/ak;

    invoke-virtual {v6}, Landroid/support/v7/widget/ak;->getWindowVisibility()I

    move-result v7

    if-nez v7, :cond_1

    invoke-virtual {v6}, Landroid/support/v7/widget/ak;->getDrawingTime()J
