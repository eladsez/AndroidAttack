...
# instance fields
.field final a:Landroid/support/v7/widget/ai$a;


# direct methods
.method constructor <init>(Landroid/support/v7/widget/ai$a;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Landroid/support/v7/widget/ai;->a:Landroid/support/v7/widget/ai$a;
...
.method private a(Ljava/util/List;II)V
    ...
    invoke-virtual/range {v1 .. v6}, Landroid/support/v7/widget/ai;->a(Ljava/util/List;ILandroid/support/v7/widget/f$b;ILandroid/support/v7/widget/f$b;)V
    ...
    invoke-direct/range {v1 .. v6}, Landroid/support/v7/widget/ai;->c(Ljava/util/List;ILandroid/support/v7/widget/f$b;ILandroid/support/v7/widget/f$b;)V
    ...
    invoke-virtual/range {v1 .. v6}, Landroid/support/v7/widget/ai;->b(Ljava/util/List;ILandroid/support/v7/widget/f$b;ILandroid/support/v7/widget/f$b;)V
...
.method a(Ljava/util/List;)V
    ...
    :goto_0
    invoke-direct {p0, p1}, Landroid/support/v7/widget/ai;->b(Ljava/util/List;)I
    ...
    invoke-direct {p0, p1, v0, v1}, Landroid/support/v7/widget/ai;->a(Ljava/util/List;II)V
...
.method a(Ljava/util/List;ILandroid/support/v7/widget/f$b;ILandroid/support/v7/widget/f$b;)V
    ...
    iget-object p1, p0, Landroid/support/v7/widget/ai;->a:Landroid/support/v7/widget/ai$a;

    invoke-interface {p1, p5}, Landroid/support/v7/widget/ai$a;->a(Landroid/support/v7/widget/f$b;)V
    ...
    iget-object v4, p0, Landroid/support/v7/widget/ai;->a:Landroid/support/v7/widget/ai$a;

    iget v7, p3, Landroid/support/v7/widget/f$b;->b:I

    add-int/2addr v7, v3

    invoke-interface {v4, v5, v7, v1, v6}, Landroid/support/v7/widget/ai$a;->a(IIILjava/lang/Object;)Landroid/support/v7/widget/f$b;
    ...
    invoke-interface {p1, p3}, Landroid/support/v7/widget/ai$a;->a(Landroid/support/v7/widget/f$b;)V
...
.method b(Ljava/util/List;ILandroid/support/v7/widget/f$b;ILandroid/support/v7/widget/f$b;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ai;->a:Landroid/support/v7/widget/ai$a;

    iget v1, p3, Landroid/support/v7/widget/f$b;->b:I

    iget-object v5, p5, Landroid/support/v7/widget/f$b;->c:Ljava/lang/Object;

    invoke-interface {v0, v2, v1, v4, v5}, Landroid/support/v7/widget/ai$a;->a(IIILjava/lang/Object;)Landroid/support/v7/widget/f$b;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/ai;->a:Landroid/support/v7/widget/ai$a;
    ...
    invoke-interface {v3, v2, v5, v1, v4}, Landroid/support/v7/widget/ai$a;->a(IIILjava/lang/Object;)Landroid/support/v7/widget/f$b;
    ...
    iget-object p3, p0, Landroid/support/v7/widget/ai;->a:Landroid/support/v7/widget/ai$a;

    invoke-interface {p3, p5}, Landroid/support/v7/widget/ai$a;->a(Landroid/support/v7/widget/f$b;)V
