...
.field private n:Landroid/support/v7/view/menu/m$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/view/menu/g;Landroid/view/View;IIZ)V
    ...
    new-instance p3, Landroid/support/v7/widget/ah;
    ...
    invoke-direct {p3, p4, v0, p5, p6}, Landroid/support/v7/widget/ah;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iput-object p3, p0, Landroid/support/v7/view/menu/r;->a:Landroid/support/v7/widget/ah;
...
.method static synthetic a(Landroid/support/v7/view/menu/r;)Landroid/view/ViewTreeObserver;
    .locals 0

    iget-object p0, p0, Landroid/support/v7/view/menu/r;->o:Landroid/view/ViewTreeObserver;

    return-object p0
.end method

.method static synthetic a(Landroid/support/v7/view/menu/r;Landroid/view/ViewTreeObserver;)Landroid/view/ViewTreeObserver;
    .locals 0

    iput-object p1, p0, Landroid/support/v7/view/menu/r;->o:Landroid/view/ViewTreeObserver;

    return-object p1
.end method

.method static synthetic b(Landroid/support/v7/view/menu/r;)Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
    .locals 0

    iget-object p0, p0, Landroid/support/v7/view/menu/r;->j:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
...
.method private h()Z
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/r;->a:Landroid/support/v7/widget/ah;

    invoke-virtual {v0, p0}, Landroid/support/v7/widget/ah;->a(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v0, p0, Landroid/support/v7/view/menu/r;->a:Landroid/support/v7/widget/ah;

    invoke-virtual {v0, p0}, Landroid/support/v7/widget/ah;->a(Landroid/widget/AdapterView$OnItemClickListener;)V
    ...
    iget-object v3, p0, Landroid/support/v7/view/menu/r;->o:Landroid/view/ViewTreeObserver;
    ...
    iput-object v4, p0, Landroid/support/v7/view/menu/r;->o:Landroid/view/ViewTreeObserver;
    ...
    iget-object v3, p0, Landroid/support/v7/view/menu/r;->a:Landroid/support/v7/widget/ah;

    invoke-virtual {v3, v0}, Landroid/support/v7/widget/ah;->b(Landroid/view/View;)V

    iget-object v0, p0, Landroid/support/v7/view/menu/r;->a:Landroid/support/v7/widget/ah;

    iget v3, p0, Landroid/support/v7/view/menu/r;->s:I

    invoke-virtual {v0, v3}, Landroid/support/v7/widget/ah;->e(I)V
    ...
    iput-boolean v1, p0, Landroid/support/v7/view/menu/r;->q:Z

    :cond_4
    iget-object v0, p0, Landroid/support/v7/view/menu/r;->a:Landroid/support/v7/widget/ah;

    iget v4, p0, Landroid/support/v7/view/menu/r;->r:I

    invoke-virtual {v0, v4}, Landroid/support/v7/widget/ah;->g(I)V

    iget-object v0, p0, Landroid/support/v7/view/menu/r;->a:Landroid/support/v7/widget/ah;

    const/4 v4, 0x2

    invoke-virtual {v0, v4}, Landroid/support/v7/widget/ah;->h(I)V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v7/widget/ah;->a(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ah;->e()Landroid/widget/ListView;

    move-result-object v0

    invoke-virtual {v0, p0}, Landroid/widget/ListView;->setOnKeyListener(Landroid/view/View$OnKeyListener;)V

    iget-boolean v4, p0, Landroid/support/v7/view/menu/r;->t:Z
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/ah;->a(Landroid/widget/ListAdapter;)V
...
.method public a(I)V
    ...
    iput p1, p0, Landroid/support/v7/view/menu/r;->s:I
...
.method public a(Landroid/support/v7/view/menu/g;Z)V
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/r;->n:Landroid/support/v7/view/menu/m$a;
...
.method public a(Landroid/support/v7/view/menu/m$a;)V
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/r;->n:Landroid/support/v7/view/menu/m$a;
...
.method public a(Landroid/support/v7/view/menu/s;)Z
    ...
    iget-object v2, p0, Landroid/support/v7/view/menu/r;->n:Landroid/support/v7/view/menu/m$a;
    ...
    iget v2, p0, Landroid/support/v7/view/menu/r;->s:I

    invoke-virtual {v0, v2}, Landroid/support/v7/view/menu/l;->a(I)V
    ...
    iget-object v2, p0, Landroid/support/v7/view/menu/r;->a:Landroid/support/v7/widget/ah;

    invoke-virtual {v2}, Landroid/support/v7/widget/ah;->j()I

    move-result v2

    iget-object v3, p0, Landroid/support/v7/view/menu/r;->a:Landroid/support/v7/widget/ah;

    invoke-virtual {v3}, Landroid/support/v7/widget/ah;->k()I
...
.method public b(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/ah;->c(I)V
...
.method public b(Z)V
    ...
    iput-boolean p1, p0, Landroid/support/v7/view/menu/r;->q:Z
...
.method public c(Z)V
    ...
    iput-boolean p1, p0, Landroid/support/v7/view/menu/r;->t:Z
...
.method public onDismiss()V
    ...
    iput-boolean v0, p0, Landroid/support/v7/view/menu/r;->p:Z

    iget-object v0, p0, Landroid/support/v7/view/menu/r;->d:Landroid/support/v7/view/menu/g;

    invoke-virtual {v0}, Landroid/support/v7/view/menu/g;->close()V

    iget-object v0, p0, Landroid/support/v7/view/menu/r;->o:Landroid/view/ViewTreeObserver;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/r;->o:Landroid/view/ViewTreeObserver;
