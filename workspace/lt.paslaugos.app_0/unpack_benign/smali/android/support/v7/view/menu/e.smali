...
.field private final m:Landroid/support/v7/widget/ag;
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/e;->m:Landroid/support/v7/widget/ag;
...
.method private c(Landroid/support/v7/view/menu/g;)V
    ...
    invoke-direct {p0}, Landroid/support/v7/view/menu/e;->h()Landroid/support/v7/widget/ah;

    move-result-object v4

    invoke-virtual {v4, v1}, Landroid/support/v7/widget/ah;->a(Landroid/widget/ListAdapter;)V

    invoke-virtual {v4, v2}, Landroid/support/v7/widget/ah;->g(I)V

    iget v1, p0, Landroid/support/v7/view/menu/e;->o:I

    invoke-virtual {v4, v1}, Landroid/support/v7/widget/ah;->e(I)V
    ...
    invoke-virtual {v4, v7}, Landroid/support/v7/widget/ah;->c(Z)V

    invoke-virtual {v4, v5}, Landroid/support/v7/widget/ah;->a(Ljava/lang/Object;)V
    ...
    invoke-virtual {v4, v6}, Landroid/support/v7/widget/ah;->b(Landroid/view/View;)V
    ...
    :goto_5
    invoke-virtual {v4, v12}, Landroid/support/v7/widget/ah;->c(I)V

    invoke-virtual {v4, v3}, Landroid/support/v7/widget/ah;->b(Z)V

    invoke-virtual {v4, v8}, Landroid/support/v7/widget/ah;->d(I)V
    ...
    invoke-virtual {v4, v2}, Landroid/support/v7/widget/ah;->c(I)V
    ...
    invoke-virtual {v4, v2}, Landroid/support/v7/widget/ah;->d(I)V
    ...
    invoke-virtual {v4, v2}, Landroid/support/v7/widget/ah;->a(Landroid/graphics/Rect;)V
    ...
    invoke-direct {v2, v4, p1, v3}, Landroid/support/v7/view/menu/e$a;-><init>(Landroid/support/v7/widget/ah;Landroid/support/v7/view/menu/g;I)V

    iget-object v3, p0, Landroid/support/v7/view/menu/e;->b:Ljava/util/List;

    invoke-interface {v3, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-virtual {v4}, Landroid/support/v7/widget/ah;->a()V

    invoke-virtual {v4}, Landroid/support/v7/widget/ah;->e()Landroid/widget/ListView;
...
.method private h()Landroid/support/v7/widget/ah;
    .locals 5
    ...
    invoke-direct {v0, v1, v4, v2, v3}, Landroid/support/v7/widget/ah;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iget-object v1, p0, Landroid/support/v7/view/menu/e;->m:Landroid/support/v7/widget/ag;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ah;->a(Landroid/support/v7/widget/ag;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ah;->b(Landroid/view/View;)V

    iget v1, p0, Landroid/support/v7/view/menu/e;->o:I

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ah;->e(I)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ah;->h(I)V
...
.method public a(Landroid/support/v7/view/menu/g;Z)V
    ...
    iget-object v1, v0, Landroid/support/v7/view/menu/e$a;->a:Landroid/support/v7/widget/ah;

    invoke-virtual {v1, v2}, Landroid/support/v7/widget/ah;->b(Ljava/lang/Object;)V

    iget-object v1, v0, Landroid/support/v7/view/menu/e$a;->a:Landroid/support/v7/widget/ah;

    invoke-virtual {v1, v3}, Landroid/support/v7/widget/ah;->b(I)V

    :cond_2
    iget-object v0, v0, Landroid/support/v7/view/menu/e$a;->a:Landroid/support/v7/widget/ah;
...
.method public c()V
    ...
    iget-object v3, v2, Landroid/support/v7/view/menu/e$a;->a:Landroid/support/v7/widget/ah;
    ...
    iget-object v2, v2, Landroid/support/v7/view/menu/e$a;->a:Landroid/support/v7/widget/ah;

    invoke-virtual {v2}, Landroid/support/v7/widget/ah;->c()V
...
.method public onDismiss()V
    ...
    iget-object v4, v3, Landroid/support/v7/view/menu/e$a;->a:Landroid/support/v7/widget/ah;

    invoke-virtual {v4}, Landroid/support/v7/widget/ah;->d()Z
