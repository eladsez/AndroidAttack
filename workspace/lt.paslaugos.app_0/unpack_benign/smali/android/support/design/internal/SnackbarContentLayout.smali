...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v0, Landroid/support/design/a$h;->SnackbarLayout:[I

    invoke-virtual {p1, p2, v0}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object p1

    sget p2, Landroid/support/design/a$h;->SnackbarLayout_android_maxWidth:I
    ...
    sget p2, Landroid/support/design/a$h;->SnackbarLayout_maxActionInlineWidth:I
...
.method private static a(Landroid/view/View;II)V
    ...
    invoke-static {p0}, Landroid/support/v4/h/q;->o(Landroid/view/View;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p0}, Landroid/support/v4/h/q;->f(Landroid/view/View;)I

    move-result v0

    invoke-static {p0}, Landroid/support/v4/h/q;->g(Landroid/view/View;)I

    move-result v1

    invoke-static {p0, v0, p1, v1, p2}, Landroid/support/v4/h/q;->a(Landroid/view/View;IIII)V
