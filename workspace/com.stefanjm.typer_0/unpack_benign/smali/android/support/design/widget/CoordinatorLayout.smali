...
.field private t:Landroid/support/v4/h/y;
...
.method private b(Landroid/support/v4/h/y;)Landroid/support/v4/h/y;
    .locals 4

    invoke-virtual {p1}, Landroid/support/v4/h/y;->e()Z
    ...
    invoke-static {v2}, Landroid/support/v4/h/q;->p(Landroid/view/View;)Z
    ...
    invoke-virtual {v3, p0, v2, p1}, Landroid/support/design/widget/CoordinatorLayout$b;->a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/support/v4/h/y;)Landroid/support/v4/h/y;
...
.method private d(Landroid/view/View;I)V
    ...
    iget-object v1, p0, Landroid/support/design/widget/CoordinatorLayout;->t:Landroid/support/v4/h/y;

    if-eqz v1, :cond_0

    invoke-static {p0}, Landroid/support/v4/h/q;->p(Landroid/view/View;)Z
    ...
    iget-object v2, p0, Landroid/support/design/widget/CoordinatorLayout;->t:Landroid/support/v4/h/y;
    ...
    invoke-virtual {v2}, Landroid/support/v4/h/y;->b()I
    ...
    invoke-virtual {v2}, Landroid/support/v4/h/y;->d()I
...
.method private f(Landroid/view/View;I)V
    ...
    invoke-static {p1, v1}, Landroid/support/v4/h/q;->b(Landroid/view/View;I)V
...
.method final a(Landroid/support/v4/h/y;)Landroid/support/v4/h/y;
    .locals 3

    iget-object v0, p0, Landroid/support/design/widget/CoordinatorLayout;->t:Landroid/support/v4/h/y;
    ...
    iput-object p1, p0, Landroid/support/design/widget/CoordinatorLayout;->t:Landroid/support/v4/h/y;
    ...
    invoke-virtual {p1}, Landroid/support/v4/h/y;->b()I
    ...
    invoke-direct {p0, p1}, Landroid/support/design/widget/CoordinatorLayout;->b(Landroid/support/v4/h/y;)Landroid/support/v4/h/y;
...
.method b(Landroid/view/View;I)V
    ...
    invoke-static {v9, v0}, Landroid/support/v4/h/q;->c(Landroid/view/View;I)V

    :cond_2
    if-eqz v1, :cond_3

    invoke-static {v9, v1}, Landroid/support/v4/h/q;->b(Landroid/view/View;I)V
...
.method public final getLastWindowInsets()Landroid/support/v4/h/y;
    .locals 1
...
.method public onAttachedToWindow()V
    ...
    invoke-static {p0}, Landroid/support/v4/h/q;->o(Landroid/view/View;)V
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {v0}, Landroid/support/v4/h/y;->b()I
...
.method protected onMeasure(II)V
    ...
    iget-object v3, v7, Landroid/support/design/widget/CoordinatorLayout;->t:Landroid/support/v4/h/y;

    if-eqz v3, :cond_1

    invoke-static/range {p0 .. p0}, Landroid/support/v4/h/q;->p(Landroid/view/View;)Z
    ...
    invoke-static {v2, v10}, Landroid/support/v4/h/d;->a(II)I
    ...
    invoke-static {v1}, Landroid/support/v4/h/q;->p(Landroid/view/View;)Z

    move-result v0

    if-nez v0, :cond_a

    iget-object v0, v7, Landroid/support/design/widget/CoordinatorLayout;->t:Landroid/support/v4/h/y;

    invoke-virtual {v0}, Landroid/support/v4/h/y;->a()I

    move-result v0

    iget-object v2, v7, Landroid/support/design/widget/CoordinatorLayout;->t:Landroid/support/v4/h/y;
    ...
    invoke-virtual {v3}, Landroid/support/v4/h/y;->d()I
