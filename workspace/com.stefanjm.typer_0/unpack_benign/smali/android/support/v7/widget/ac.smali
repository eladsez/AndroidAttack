...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/ac;->b:Landroid/support/v7/widget/h;

    iget-object p1, p0, Landroid/support/v7/widget/ac;->b:Landroid/support/v7/widget/h;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/ac;->c:Landroid/support/v7/widget/aa;

    iget-object p1, p0, Landroid/support/v7/widget/ac;->c:Landroid/support/v7/widget/aa;
...
.method protected drawableStateChanged()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ac;->b:Landroid/support/v7/widget/h;
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/ac;->c:Landroid/support/v7/widget/aa;
...
.method public getAutoSizeMaxTextSize()I
    ...
    sget-boolean v0, Landroid/support/v7/widget/ac;->a:Z
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/aa;->g()I
...
.method public getAutoSizeMinTextSize()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/aa;->f()I
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ac;->c:Landroid/support/v7/widget/aa;
    ...
    invoke-virtual/range {v1 .. v6}, Landroid/support/v7/widget/aa;->a(ZIIII)V
...
.method protected onTextChanged(Ljava/lang/CharSequence;III)V
    ...
    sget-boolean p1, Landroid/support/v7/widget/ac;->a:Z

    if-nez p1, :cond_0

    iget-object p1, p0, Landroid/support/v7/widget/ac;->c:Landroid/support/v7/widget/aa;

    invoke-virtual {p1}, Landroid/support/v7/widget/aa;->c()Z
    ...
    invoke-virtual {p1}, Landroid/support/v7/widget/aa;->b()V
