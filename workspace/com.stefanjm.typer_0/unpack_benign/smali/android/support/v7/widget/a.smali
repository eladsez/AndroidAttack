...
.method public a(IJ)Landroid/support/v4/h/u;
    .locals 2

    iget-object v0, p0, Landroid/support/v7/widget/a;->f:Landroid/support/v4/h/u;
    ...
    :cond_1
    invoke-static {p0}, Landroid/support/v4/h/q;->k(Landroid/view/View;)Landroid/support/v4/h/u;

    move-result-object v0

    const/high16 v1, 0x3f800000    # 1.0f

    invoke-virtual {v0, v1}, Landroid/support/v4/h/u;->a(F)Landroid/support/v4/h/u;

    move-result-object v0

    :goto_0
    invoke-virtual {v0, p2, p3}, Landroid/support/v4/h/u;->a(J)Landroid/support/v4/h/u;

    iget-object p2, p0, Landroid/support/v7/widget/a;->a:Landroid/support/v7/widget/a$a;

    invoke-virtual {p2, v0, p1}, Landroid/support/v7/widget/a$a;->a(Landroid/support/v4/h/u;I)Landroid/support/v7/widget/a$a;

    move-result-object p1

    invoke-virtual {v0, p1}, Landroid/support/v4/h/u;->a(Landroid/support/v4/h/v;)Landroid/support/v4/h/u;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v4/h/u;->a(F)Landroid/support/v4/h/u;
