...
.field private n:Landroid/support/v7/widget/aq;
...
.method a(I)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/ActivityChooserView;->getListPopupWindow()Landroid/support/v7/widget/aq;

    move-result-object p1

    invoke-virtual {p1}, Landroid/support/v7/widget/aq;->d()Z
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/widget/aq;->g(I)V

    invoke-virtual {p1}, Landroid/support/v7/widget/aq;->a()V
    ...
    :cond_5
    invoke-virtual {p1}, Landroid/support/v7/widget/aq;->e()Landroid/widget/ListView;
...
.method getListPopupWindow()Landroid/support/v7/widget/aq;
    .locals 2

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->n:Landroid/support/v7/widget/aq;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->n:Landroid/support/v7/widget/aq;
    ...
    invoke-virtual {v0, p0}, Landroid/support/v7/widget/aq;->b(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/aq;->a(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView;->n:Landroid/support/v7/widget/aq;

    iget-object v1, p0, Landroid/support/v7/widget/ActivityChooserView;->i:Landroid/support/v7/widget/ActivityChooserView$b;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/aq;->a(Landroid/widget/PopupWindow$OnDismissListener;)V
