...
.method private a(Landroid/graphics/drawable/Drawable;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/q;->d:Landroid/support/v7/widget/bg;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/q;->d:Landroid/support/v7/widget/bg;
...
.method private e()Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/q;->b:Landroid/support/v7/widget/bg;
...
.method public a(I)V
    ...
    invoke-static {p1}, Landroid/support/v7/widget/ai;->a(Landroid/graphics/drawable/Drawable;)V
...
.method a(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/q;->c:Landroid/support/v7/widget/bg;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/q;->c:Landroid/support/v7/widget/bg;
    ...
    iget-object p1, p0, Landroid/support/v7/widget/q;->c:Landroid/support/v7/widget/bg;
...
.method public a(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p2}, Landroid/support/v7/widget/ai;->a(Landroid/graphics/drawable/Drawable;)V
...
.method d()V
    ...
    invoke-static {v0}, Landroid/support/v7/widget/ai;->a(Landroid/graphics/drawable/Drawable;)V

    :cond_0
    if-eqz v0, :cond_3

    invoke-direct {p0}, Landroid/support/v7/widget/q;->e()Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-direct {p0, v0}, Landroid/support/v7/widget/q;->a(Landroid/graphics/drawable/Drawable;)Z
    ...
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/q;->c:Landroid/support/v7/widget/bg;
    ...
    :cond_2
    iget-object v1, p0, Landroid/support/v7/widget/q;->b:Landroid/support/v7/widget/bg;
