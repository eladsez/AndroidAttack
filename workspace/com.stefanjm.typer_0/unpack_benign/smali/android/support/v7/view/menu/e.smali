...
.method private c(Landroid/support/v7/view/menu/h;)V
    ...
    invoke-virtual {v4, v1}, Landroid/support/v7/widget/as;->a(Landroid/widget/ListAdapter;)V

    invoke-virtual {v4, v2}, Landroid/support/v7/widget/as;->g(I)V

    iget v1, p0, Landroid/support/v7/view/menu/e;->o:I

    invoke-virtual {v4, v1}, Landroid/support/v7/widget/as;->e(I)V
    ...
    invoke-virtual {v4, v7}, Landroid/support/v7/widget/as;->c(Z)V

    invoke-virtual {v4, v5}, Landroid/support/v7/widget/as;->a(Ljava/lang/Object;)V
    ...
    invoke-virtual {v4, v6}, Landroid/support/v7/widget/as;->b(Landroid/view/View;)V
    ...
    :goto_5
    invoke-virtual {v4, v12}, Landroid/support/v7/widget/as;->c(I)V

    invoke-virtual {v4, v3}, Landroid/support/v7/widget/as;->b(Z)V

    invoke-virtual {v4, v8}, Landroid/support/v7/widget/as;->d(I)V
    ...
    invoke-virtual {v4, v2}, Landroid/support/v7/widget/as;->c(I)V
    ...
    invoke-virtual {v4, v2}, Landroid/support/v7/widget/as;->d(I)V
    ...
    invoke-virtual {v4, v2}, Landroid/support/v7/widget/as;->a(Landroid/graphics/Rect;)V
    ...
    invoke-direct {v2, v4, p1, v3}, Landroid/support/v7/view/menu/e$a;-><init>(Landroid/support/v7/widget/as;Landroid/support/v7/view/menu/h;I)V

    iget-object v3, p0, Landroid/support/v7/view/menu/e;->b:Ljava/util/List;

    invoke-interface {v3, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-virtual {v4}, Landroid/support/v7/widget/as;->a()V

    invoke-virtual {v4}, Landroid/support/v7/widget/as;->e()Landroid/widget/ListView;
...
.method private h()Landroid/support/v7/widget/as;
    ...
    invoke-direct {v0, v1, v4, v2, v3}, Landroid/support/v7/widget/as;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
...
.method public a(Landroid/support/v7/view/menu/h;Z)V
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/widget/as;->b(Ljava/lang/Object;)V
...
.method public onDismiss()V
    ...
    iget-object v4, v3, Landroid/support/v7/view/menu/e$a;->a:Landroid/support/v7/widget/as;

    invoke-virtual {v4}, Landroid/support/v7/widget/as;->d()Z
