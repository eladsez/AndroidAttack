...
.field private u:Landroid/support/v7/widget/af;
...
.method constructor <init>(Landroid/content/Context;Landroid/view/Window;Landroid/support/v7/app/d;)V
    ...
    iput-object p1, p0, Landroid/support/v7/app/j;->q:Landroid/support/v4/h/u;
...
.method private a(Landroid/support/v7/view/menu/h;Z)V
    ...
    iget-object p1, p0, Landroid/support/v7/app/j;->u:Landroid/support/v7/widget/af;
    ...
    invoke-interface {p1}, Landroid/support/v7/widget/af;->e()Z
    ...
    invoke-interface {p1}, Landroid/support/v7/widget/af;->g()Z
    ...
    iget-object v2, p0, Landroid/support/v7/app/j;->u:Landroid/support/v7/widget/af;

    invoke-interface {v2}, Landroid/support/v7/widget/af;->f()Z
    ...
    :cond_1
    iget-object p2, p0, Landroid/support/v7/app/j;->u:Landroid/support/v7/widget/af;

    invoke-interface {p2}, Landroid/support/v7/widget/af;->i()Z
    ...
    invoke-interface {p1}, Landroid/support/v7/widget/af;->h()Z
...
.method private a(Landroid/support/v7/app/j$d;ILandroid/view/KeyEvent;I)Z
    ...
    iget-object p3, p0, Landroid/support/v7/app/j;->u:Landroid/support/v7/widget/af;
...
.method private b(Landroid/support/v7/app/j$d;)Z
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v7/app/j;->u:Landroid/support/v7/widget/af;
...
.method private b(Landroid/support/v7/app/j$d;Landroid/view/KeyEvent;)Z
    ...
    iget-object v4, p0, Landroid/support/v7/app/j;->u:Landroid/support/v7/widget/af;
    ...
    invoke-interface {v4, v6, v7}, Landroid/support/v7/widget/af;->a(Landroid/view/Menu;Landroid/support/v7/view/menu/o$a;)V
    ...
    invoke-interface {p1, v5, p2}, Landroid/support/v7/widget/af;->a(Landroid/view/Menu;Landroid/support/v7/view/menu/o$a;)V
    ...
    invoke-interface {p2, v5, v0}, Landroid/support/v7/widget/af;->a(Landroid/view/Menu;Landroid/support/v7/view/menu/o$a;)V
...
.method private d(I)V
    ...
    invoke-static {p1, v0}, Landroid/support/v4/h/q;->a(Landroid/view/View;Ljava/lang/Runnable;)V
...
.method private e(ILandroid/view/KeyEvent;)Z
    ...
    invoke-interface {p1}, Landroid/support/v7/widget/af;->f()Z
    ...
    invoke-interface {p1}, Landroid/support/v7/widget/af;->i()Z
...
.method private x()Landroid/view/ViewGroup;
    ...
    iput-object v1, p0, Landroid/support/v7/app/j;->u:Landroid/support/v7/widget/af;
    ...
    invoke-interface {v1, v3}, Landroid/support/v7/widget/af;->setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v1, v4}, Landroid/support/v7/widget/af;->a(I)V
    ...
    invoke-interface {v1, v3}, Landroid/support/v7/widget/af;->a(I)V
    ...
    invoke-static {v0, v1}, Landroid/support/v4/h/q;->a(Landroid/view/View;Landroid/support/v4/h/o;)V
    ...
    invoke-interface {v1, v3}, Landroid/support/v7/widget/al;->setOnFitSystemWindowsListener(Landroid/support/v7/widget/al$a;)V
...
.method a(Landroid/support/v7/view/b$a;)Landroid/support/v7/view/b;
    ...
    invoke-virtual {p1, v0}, Landroid/support/v4/h/u;->a(F)Landroid/support/v4/h/u;

    move-result-object p1

    iput-object p1, p0, Landroid/support/v7/app/j;->q:Landroid/support/v4/h/u;

    iget-object p1, p0, Landroid/support/v7/app/j;->q:Landroid/support/v4/h/u;
    ...
    invoke-virtual {p1, v0}, Landroid/support/v4/h/u;->a(Landroid/support/v4/h/v;)Landroid/support/v4/h/u;
...
.method a(Landroid/support/v7/app/j$d;Z)V
    ...
    iget-object v0, p0, Landroid/support/v7/app/j;->u:Landroid/support/v7/widget/af;
...
.method public a(Landroid/support/v7/widget/Toolbar;)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/app/n;->h()Landroid/view/Window$Callback;
...
.method t()V
    ...
    iget-object v0, p0, Landroid/support/v7/app/j;->q:Landroid/support/v4/h/u;
